...
distorted_images = glob.glob('03/*.jpg')
#distorted_img_filename = 'dist/20000101_015800.bmp'
...
square_size = 0.045 # Length of the side of a square in meters
...
def main():
  ...
  # Go through each chessboard image, one by one
  for distorted_img_filename in distorted_images:
